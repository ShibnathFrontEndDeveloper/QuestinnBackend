            ...
            <div class="col-lg-8 room_booking_box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="" class="form-label">Check In</label>
                                <input id="start_date{{$room->id}}" type="date" name="check_in" class="form-control" required onChange="myFunction('{{$room->id}}')">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="" class="form-label">Check Out</label>
                                <input id="end_date{{$room->id}}" type="date" name="check_out" class="form-control" required onChange="myFunction('{{$room->id}}')">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-3">
...
// console.log(diffDays);
    ...
    $.get({
        ...
        success: function (data) {
            console.log("success...");
            $('#amount').empty().html(data.amount);
            $('#total').empty().html(data.total);
            $('#sub_total').empty().html(data.total);
