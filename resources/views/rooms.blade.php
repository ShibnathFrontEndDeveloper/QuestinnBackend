              ...
              <div class="container-fluid flex-lg-column align-items-stretch">
                ...
                <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                  <div class="border bg-light p-3 rounded mb-3">
                    ...
                    <input type="date" name="form_date" id="from_date" value="" onchange="formDate(this.value)" class="form-control shadow-none mb-3" required>
                    <label class="form-label">Check-Out</label>
                    <input type="date" name="to_date" id="to_date" value="" onchange="toDate(this.value)" class="form-control shadow-none" required>
                  </div>
                  <div class="border bg-light p-3 rounded mb-3">
                  ...
                  <div class="border bg-light p-3 rounded mb-3">
                    ...
                    <div class="d-flex">
                      ...
                      <input type="number" name="adults" id="adults" class="form-control shadow-none" required>
                    </div>
                    <div>
    ...
    <div class="col-lg-9 col-md-12 px-4" id="search_data">
      ...
      <div class="row g-0 p-3 align-items-center">
        ...
        <div class="col-md-2 mt-lg-0 mt-md-0 mt-4 text-center">
          ...
          <a href="{{route('room_booking',$values->slug)}}" class="btn btn-sm w-100 text-white bg-dark shadow-none mb-2">Book Now</a>
...
<script>
  ...
  //   var data = $("#searchByFilter").serializeArray();

  //   console.log(data);
  //    var fromDate = data[1].value;     
  //    var toDate = data[2].value;
  //    var facilities = data[3].value;  
  //    var adults = data[4].value;
  //    var childrens = data[5].value;
  //     if (fromDate == "" || toDate == "" || facilities == "" || adults == "" || childrens == "") {
