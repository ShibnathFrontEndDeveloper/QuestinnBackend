...
<div class="card">
    <div class="card-body">
      ...
      <form class="row g-3" action="{{route('admin.about.management_team.update',$edit->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
		@if (count($errors) > 0)
        ...
        <div class="col-12">
            ...
            <input type="text" name="name" class="form-control" id="inputNanme4" value="{{$edit->name}}" required>
        </div>
