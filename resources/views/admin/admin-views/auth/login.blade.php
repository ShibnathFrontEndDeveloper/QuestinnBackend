...
<link rel="icon" type="image/x-icon" href="{{asset('public/images/faveicon.png')}}">
  <!-- Favicons -->
  <!--<link href="{{asset('public/images/faveicon.png')}}" rel="icon">-->
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="" class="logo d-flex align-items-center w-auto">
                   <img src="{{asset('public/images/questinn_logo_admin.png')}}" alt="" class="brand_logo"> 
                  <!--<img src="{{asset('')}}" alt="">-->
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Welcom to Questinn</h5>
